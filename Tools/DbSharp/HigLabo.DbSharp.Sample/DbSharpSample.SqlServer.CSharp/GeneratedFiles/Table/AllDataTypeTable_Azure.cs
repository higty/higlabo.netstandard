...
{
    public partial class AllDataTypeTable_Azure : Table<AllDataTypeTable_Azure.Record>
    {
        public const String Name = "AllDataTypeTable_Azure";

        public override String TableName
        {
            get
            {
                return AllDataTypeTable_Azure.Name;
            }
        }

        public AllDataTypeTable_Azure()
        {
        ...
        {
            var spInsert = storedProcedure as AllDataTypeTable_AzureInsert;
            if (spInsert != null)
            {
                record.TimestampColumn = spInsert.TimestampColumn;
            }
            var spUpdate = storedProcedure as AllDataTypeTable_AzureUpdate;
            if (spUpdate != null)
            {
        ...
        public AllDataTypeTable_AzureSelectAll CreateSelectAllStoredProcedure()
        {
            return new AllDataTypeTable_AzureSelectAll();
        }
