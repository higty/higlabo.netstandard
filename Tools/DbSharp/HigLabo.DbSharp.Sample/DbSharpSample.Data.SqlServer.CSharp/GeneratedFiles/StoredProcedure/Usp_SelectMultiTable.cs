...
{
    public partial class Usp_SelectMultiTable : StoredProcedureWithResultSetsList<Usp_SelectMultiTable.AllDataTypeTableResultSet, Usp_SelectMultiTable.ResultSetsList>
    {
        ...
        public Usp_SelectMultiTable()
        {
            ...
            ConstructorExecuted();
            _MergeMethod = Merge;
            _CreateResultSetMethodList.Add(CreateCreateResultSetMethod<AllDataTypeTableResultSet>(this.SetResultSet));
            _CreateResultSetMethodList.Add(CreateCreateResultSetMethod<IdentityTableResultSet>(this.SetResultSet));
            _CreateResultSetMethodList.Add(CreateCreateResultSetMethod<RowGuidColTableResultSet>(this.SetResultSet));
            _CreateResultSetMethodList.Add(CreateCreateResultSetMethod<MultiPkTableResultSet>(this.SetResultSet));
        }
        ...
        public override Usp_SelectMultiTable.AllDataTypeTableResultSet CreateResultSet()
        {
            return new AllDataTypeTableResultSet(this);
        }
        protected override void SetResultSet(Usp_SelectMultiTable.AllDataTypeTableResultSet resultSet, IDataReader reader)
        {
            var r = resultSet;
            Int32 index = -1;
            try
        ...
        protected void SetResultSet(Usp_SelectMultiTable.IdentityTableResultSet resultSet, IDataReader reader)
        {
            var r = resultSet;
            Int32 index = -1;
            try
        ...
        protected void SetResultSet(Usp_SelectMultiTable.RowGuidColTableResultSet resultSet, IDataReader reader)
        {
            var r = resultSet;
            Int32 index = -1;
            try
        ...
        protected void SetResultSet(Usp_SelectMultiTable.MultiPkTableResultSet resultSet, IDataReader reader)
        {
            var r = resultSet;
            Int32 index = -1;
            try
        ...
        protected override void SetResultSetsList(ResultSetsList resultSetsList, List<List<StoredProcedureResultSet>> list)
        {
            ...
            var l = list;
            rs.AllDataTypeTableResultSetList.AddRange(l[0].ConvertAll(el => (AllDataTypeTableResultSet)el));
            rs.IdentityTableResultSetList.AddRange(l[1].ConvertAll(el => (IdentityTableResultSet)el));
        ...
        {
            target.AllDataTypeTableResultSetList.AddRange(source.AllDataTypeTableResultSetList);
            target.IdentityTableResultSetList.AddRange(source.IdentityTableResultSetList);
            target.RowGuidColTableResultSetList.AddRange(source.RowGuidColTableResultSetList);
            target.MultiPkTableResultSetList.AddRange(source.MultiPkTableResultSetList);
        }
        ...
        public partial class AllDataTypeTableResultSet : StoredProcedureResultSet, AllDataTypeTable.IRecord
        {
            ...
            public AllDataTypeTableResultSet()
            {
            }
            public AllDataTypeTableResultSet(AllDataTypeTableResultSet resultSet)
            {
                var r = resultSet;
            ...
            public override String ToString()
            {
                ...
                sb.AppendLine("<Usp_SelectMultiTable.AllDataTypeTableResultSet>");
        ...
        public partial class IdentityTableResultSet : StoredProcedureResultSet, IdentityTable.IRecord
        {
            private Int32 _IntColumn;
            private String _NVarCharColumn = null;
            ...
            public IdentityTableResultSet()
            {
            }
            public IdentityTableResultSet(IdentityTableResultSet resultSet)
            {
                var r = resultSet;
                IntColumn = r.IntColumn;
                NVarCharColumn = r.NVarCharColumn;
            }
            internal IdentityTableResultSet(Usp_SelectMultiTable storedProcedure)
            {
                this._StoredProcedureResultSet_StoredProcedure = storedProcedure;
            }
            ...
            {
                var sb = new StringBuilder(64);
                sb.AppendLine("<Usp_SelectMultiTable.IdentityTableResultSet>");
                sb.AppendFormat("IntColumn={0}", this.IntColumn); sb.AppendLine();
                sb.AppendFormat("NVarCharColumn={0}", this.NVarCharColumn); sb.AppendLine();
                return sb.ToString();
            }
        }
        public partial class RowGuidColTableResultSet : StoredProcedureResultSet, RowGuidColTable.IRecord
        {
            ...
            public RowGuidColTableResultSet()
            {
            }
            public RowGuidColTableResultSet(RowGuidColTableResultSet resultSet)
            {
                var r = resultSet;
                RowGuidColumn = r.RowGuidColumn;
                NVarCharColumn = r.NVarCharColumn;
            }
            internal RowGuidColTableResultSet(Usp_SelectMultiTable storedProcedure)
            {
                this._StoredProcedureResultSet_StoredProcedure = storedProcedure;
            }
            ...
            {
                var sb = new StringBuilder(64);
                sb.AppendLine("<Usp_SelectMultiTable.RowGuidColTableResultSet>");
                sb.AppendFormat("RowGuidColumn={0}", this.RowGuidColumn); sb.AppendLine();
                sb.AppendFormat("NVarCharColumn={0}", this.NVarCharColumn); sb.AppendLine();
                return sb.ToString();
            }
        }
        public partial class MultiPkTableResultSet : StoredProcedureResultSet, MultiPkTable.IRecord
        {
            private Int64 _BigIntColumn;
            private Int32 _IntColumn;
            private Double _FloatColumn;
            ...
            public MultiPkTableResultSet()
            {
            }
            public MultiPkTableResultSet(MultiPkTableResultSet resultSet)
            {
                var r = resultSet;
                BigIntColumn = r.BigIntColumn;
                IntColumn = r.IntColumn;
            ...
            internal MultiPkTableResultSet(Usp_SelectMultiTable storedProcedure)
            {
                this._StoredProcedureResultSet_StoredProcedure = storedProcedure;
            }
            ...
            {
                var sb = new StringBuilder(64);
                sb.AppendLine("<Usp_SelectMultiTable.MultiPkTableResultSet>");
                sb.AppendFormat("BigIntColumn={0}", this.BigIntColumn); sb.AppendLine();
                sb.AppendFormat("IntColumn={0}", this.IntColumn); sb.AppendLine();
                sb.AppendFormat("FloatColumn={0}", this.FloatColumn); sb.AppendLine();
                sb.AppendFormat("BinaryColumn={0}", this.BinaryColumn); sb.AppendLine();
        ...
        {
            private List<AllDataTypeTableResultSet> _AllDataTypeTableResultSetList = new List<AllDataTypeTableResultSet>();
            private List<IdentityTableResultSet> _IdentityTableResultSetList = new List<IdentityTableResultSet>();
            private List<RowGuidColTableResultSet> _RowGuidColTableResultSetList = new List<RowGuidColTableResultSet>();
            private List<MultiPkTableResultSet> _MultiPkTableResultSetList = new List<MultiPkTableResultSet>();

            public List<AllDataTypeTableResultSet> AllDataTypeTableResultSetList
            {
                get
                {
                    return _AllDataTypeTableResultSetList;
                }
            }
            public List<IdentityTableResultSet> IdentityTableResultSetList
            {
                get
                {
                    return _IdentityTableResultSetList;
                }
            }
            public List<RowGuidColTableResultSet> RowGuidColTableResultSetList
            {
                get
                {
                    return _RowGuidColTableResultSetList;
                }
            }
            public List<MultiPkTableResultSet> MultiPkTableResultSetList
            {
                get
                {
                    return _MultiPkTableResultSetList;
                }
            }
